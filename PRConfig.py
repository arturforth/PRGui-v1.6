...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.lineEdit1BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit1BAP, 'Id'))
        self.lineEdit2BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit2BAP, 'NroSucursal'))
        self.lineEdit3BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit3BAP, 'NombreSucursal'))
        self.lineEdit4BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit4BAP, 'InfoExtra'))
        self.lineEdit5BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit5BAP, 'IP_Port'))
        self.lineEdit6BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit6BAP, 'NroAbonadoKANT'))
        self.lineEdit7BAP.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP2,
                                                                                 self.lineEdit7BAP, 'IDPlaca'))
        ...
        # Configuracion para BAPInfoManager.dat
        self.lineEdit1BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit1BAP3, 'Id', 'BAP3'))
        self.lineEdit2BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit2BAP3, 'NroSucursal',
                                                                                  'BAP3'))
        self.lineEdit3BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit3BAP3, 'NombreSucursal',
                                                                                  'BAP3'))
        self.lineEdit4BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit4BAP3, 'InfoExtra',
                                                                                  'BAP3'))
        self.lineEdit5BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit5BAP3, 'IP_Port',
                                                                                  'BAP3'))
        self.lineEdit6BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit6BAP3, 'NroAbonadoKANT',
                                                                                  'BAP3'))
        self.lineEdit7BAP3.editingFinished.connect(lambda: self.ModelBAP.writeDat(self.listWidgetPlacasBAP3,
                                                                                  self.lineEdit7BAP3, 'IDPlaca',
                                                                                  'BAP3'))
        ...
        self.lineEdit1CON.editingFinished.connect(lambda: self.ModelCON.writeDat(self.listWidgetConsolas,
                                                                                 self.lineEdit1CON, 'Id'))
        self.lineEdit2CON.editingFinished.connect(lambda: self.ModelCON.writeDat(self.listWidgetConsolas,
                                                                                 self.lineEdit2CON, 'NombreConsola'))
        self.lineEdit3CON.editingFinished.connect(lambda: self.ModelCON.writeDat(self.listWidgetConsolas,
                                                                                 self.lineEdit3CON, 'InfoExtra'))
        self.lineEdit4CON.editingFinished.connect(lambda: self.ModelCON.writeDat(self.listWidgetConsolas,
                                                                                 self.lineEdit4CON, 'IP'))
        self.lineEdit5CON.editingFinished.connect(lambda: self.ModelCON.writeDat(self.listWidgetConsolas,
                                                                                 self.lineEdit5CON, 'NroNodoKANT'))
        ...
        self.lineEdit1KAN.editingFinished.connect(lambda: self.ModelKAN.writeDat(self.listWidgetKants,
                                                                                 self.lineEdit1KAN, 'NroNodo'))
        self.lineEdit2KAN.editingFinished.connect(lambda: self.ModelKAN.writeDat(self.listWidgetKants,
                                                                                 self.lineEdit2KAN, 'NombreKant'))
        self.lineEdit3KAN.editingFinished.connect(lambda: self.ModelKAN.writeDat(self.listWidgetKants,
                                                                                 self.lineEdit3KAN, 'IP_Port'))
        self.lineEdit4KAN.editingFinished.connect(lambda: self.ModelKAN.writeDat(self.listWidgetKants,
                                                                                 self.lineEdit4KAN, 'AliveFrequency'))
        self.lineEdit5KAN.editingFinished.connect(lambda: self.ModelKAN.writeDat(self.listWidgetKants,
                                                                                 self.lineEdit5KAN, 'RetryFrequency'))
