...
class Ui_MainWindow:
    ...
    def createConfigurationBAP3GroupBox(self):
        ...
        self.agregarEventoConfig.setObjectName('AgregarEventoConfig')
        self.agregarEventoConfig.setFont(self.newfont)

        self.removerEventoConfig = QtWidgets.QPushButton(self.ConfigurationBAP3GroupBox)
        self.removerEventoConfig.setGeometry(QtCore.QRect(110, 30, 40, 30))
        self.removerEventoConfig.setObjectName('RemoverEventoConfig')
        self.removerEventoConfig.setFont(self.newfont)

        self.removerBotonConfig = QtWidgets.QPushButton(self.ConfigurationBAP3GroupBox)
        self.removerBotonConfig.setGeometry(QtCore.QRect(155, 30, 40, 30))
        self.removerBotonConfig.setObjectName('RemoverBotonConfig')
        self.removerBotonConfig.setFont(self.newfont)

        self.guardarConfig = QtWidgets.QPushButton(self.ConfigurationBAP3GroupBox)
        self.guardarConfig.setGeometry(QtCore.QRect(200, 30, 40, 30))
        self.guardarConfig.setObjectName('GuardarConfig')
        self.guardarConfig.setFont(self.newfont)

        # OutsNum
        self.labelspinBoxOutsNumConfig = QtWidgets.QLabel(self.ConfigurationBAP3GroupBox)
        self.labelspinBoxOutsNumConfig.setGeometry(QtCore.QRect(335, 35, 150, 20))
        self.labelspinBoxOutsNumConfig.setText('OutsNum')

        self.spinBoxOutsNumConfig = QtWidgets.QSpinBox(self.ConfigurationBAP3GroupBox)
        self.spinBoxOutsNumConfig.setGeometry(QtCore.QRect(395, 35, 40, 20))
        self.spinBoxOutsNumConfig.setObjectName("OutsNumConfigGroupBox")
        ...
        self.listaBotonesConfig = QtWidgets.QListWidget(self.ConfigurationBAP3GroupBox)
        self.listaBotonesConfig.setGeometry(QtCore.QRect(130, 70, 100, 170))
        self.listaBotonesConfig.setObjectName('listaBotonesConfig')

        self.listaEventosConfig = QtWidgets.QListWidget(self.ConfigurationBAP3GroupBox)
        self.listaEventosConfig.setGeometry(QtCore.QRect(240, 70, 100, 170))
        self.listaEventosConfig.setObjectName('ListaEventosConfig')

        # Accion
        self.labelAccionConfig = QtWidgets.QLabel(self.ConfigurationBAP3GroupBox)
        self.labelAccionConfig.setGeometry(QtCore.QRect(350, 70, 89, 16))
        self.labelAccionConfig.setObjectName("LabelAccionConfig")

        self.comboBox1Config = QtWidgets.QComboBox(self.ConfigurationBAP3GroupBox)
        self.comboBox1Config.setGeometry(QtCore.QRect(350, 90, 85, 20))
        self.comboBox1Config.setEditable(False)
        self.comboBox1Config.setObjectName("ComboAccionConfig")
        self.comboBox1Config.addItem("")
        self.comboBox1Config.addItem("")
        self.comboBox1Config.addItem("")

        self.comboBox1Config.setCurrentText("")
        self.comboBox1Config.setItemText(0, "PULSAR")
        self.comboBox1Config.setItemText(1, "ENCENDER")
        self.comboBox1Config.setItemText(2, "APAGAR")

        # Salida
        self.labelSalidaConfig = QtWidgets.QLabel(self.ConfigurationBAP3GroupBox)
        self.labelSalidaConfig.setGeometry(QtCore.QRect(350, 110, 89, 16))
        self.labelSalidaConfig.setObjectName("LabelSalidaConfig")
        ...
        self.guardarConfig.setText('')

        self.labelAccionConfig.setText('Accion')
        self.labelSalidaConfig.setText('Salida')
